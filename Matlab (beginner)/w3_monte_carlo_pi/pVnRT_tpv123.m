...
if (quantity2 == 2);
    ...
    fprintf('For 1 mole of gas at %6.2f K and %6.2f m^3, the pressure is %9.2f Pa (using R = 8.315 J/mol/K).\n',quantity1value,quantity2value,pressure);
end
end
...
if (quantity2 == 1);
    ...
    temperature = quantity1value*quantity2value/(n*R);
    fprintf('For 1 mole of gas at %6.2f m^3 and %9.2f Pa, the temperature is %9.2f K (using R = 8.315 J/mol/K).\n',quantity1value,quantity2value,temperature);
end
end
